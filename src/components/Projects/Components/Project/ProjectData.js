const projects = [
  ...
  },
  {
    title: "Inspire",
    blurb:
      "This project was a quick solo build utilizing Vue.js. It's a home page where users can see the time, weather and an inspirantional quote; as well as create a to-do list where tasks can be marked as completed or deleted.",
    githubLink: "https://github.com/MonroeGollaher/VueInspire",
  },
  {
    title: "Bloggz",
    blurb:
