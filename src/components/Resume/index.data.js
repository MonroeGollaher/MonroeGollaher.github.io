const jobData = [
  {
    ...
    dates: "Oct '23 - Current",
    lineItems: [
      "Software development in the real estate sector using React w/Redux.",
      "Mixture of feature work and improving the clients website accessibility.",
    ],
  },
  {
    company: "MadeLabs",
    ...
    dates: "Nov '22 - Aug '23",
    lineItems: [
      "Software development in the financial tech space using React w/Redux and a Java backend.",
      "Worked on different features and bug fixes for a large 20+ year old codebase.",
      "Experience with Jenkins, IntelliJ, DBeaver and more.",
      "Worked on internal projects using React & C#.",
    ],
  },
  {
    company: "Foundry Interactive",
